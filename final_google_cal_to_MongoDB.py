...
BASE_DIR = "/Users/snehbhandari/Documents/Project/Calendar Automation Project"

# json file containing all the calendar ids 
cal_ids = os.path.join(BASE_DIR, 'calendars.json')
...
def main():
    ...
    if not creds or not creds.valid:
        if creds and creds.expired and creds.refresh_token:
            ...
            calendar_auth_path = os.path.join(BASE_DIR, 'calendar_auth.json')
            flow = InstalledAppFlow.from_client_secrets_file(calendar_auth_path, SCOPES)
    ...
    calendar_ids = load_calendar_ids(cal_ids)
